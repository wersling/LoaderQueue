...
public class URLLoaderAdapterTest
{		
    ...
    {
        loaderAdapter1 = new URLLoaderAdapter(1, new URLRequest(TestURL.PIC1));
    ...
    private function verifyComplete(...arg):void
    {
        ...
        Assert.assertTrue(URLLoaderAdapter(loaderAdapter1).data != null);
    }
}
}