...
public class URLStreamAdapterTest
{		
    ...
    {
        loaderAdapter1 = new URLStreamAdapter(1, new URLRequest(TestURL.BYTES));
    ...
    private function verifyComplete(...arg):void
    {
        ...
        Assert.assertTrue(URLStreamAdapter(loaderAdapter1).adaptee.bytesAvailable > 0);
    }
}
}